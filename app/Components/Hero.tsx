...
const Hero = () => {
  return (
    <div className='flex flex-col lg:flex-row lg:justify-center w-full  lg:h-[704px]'>
        <div className='flex justify-between w-full  lg:w-[1280px] lg:mx-[60px] lg:mt-[60px] bg-[#2A254B] text-white pl-[60px] h-[540px]  lg:h-[580px]'>
            <div>
                ...
                <div className='w-full lg:w-[602px] h-[81px]  lg:pt-[210px] clash font-normal text-lg md:text-left'>A new era in eco friendly furniture with Avelon, the French luxury retail brand with nice fonts, tasteful colors and a beautiful way to display things digitally using modern web technologies.</div>
