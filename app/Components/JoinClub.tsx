...
const JoinClub = () => {
  return (
    <div className='w-full h-[396px] bg-[#F9F9F9] py-6'>
      <div className='max-w-screen-xl mx-auto flex flex-col justify-center items-center space-y-4 h-[316px] mt-[52px] px-4 md:px-8"mt-[52px] bg-white '>
